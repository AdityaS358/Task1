...
public class edureka {
    ...
    button.click();
    Thread.sleep(5000);
    driver.findElement(By.id("si_popup_email")).sendKeys("shahareadi01@gmail.com");
    driver.findElement(By.id("si_popup_passwd")).sendKeys("Pass@123");
    ...
    personalDetials.sendKeys("Aditya");
