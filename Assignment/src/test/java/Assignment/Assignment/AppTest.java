...
public class AppTest {
    ...
    emailInput.sendKeys("shahareadi01@gmail.com");
    
    WebElement passInput= driver.findElement(By.id("si_popup_passwd"));
    passInput.sendKeys("Pass@123");
    
    WebElement loginbtn = driver.findElement(By.xpath("/html/body/div[6]/div/div/div[2]/div[3]/form/button"));
    loginbtn.click();
    Thread.sleep(5000);
    ...
    personalDetials.sendKeys("Aditya Shahare");
